  ...
  return [
    {
      ...
      events: [
        ...
        },
        {
          ...
          year: 2015,
          description:
            "Компания Google представила второе поколение очков дополненной реальности Google Glass Enterprise Edition",
        },
        {
          id: 5,
          year: 2016,
          description:
            "Компания SpaceX впервые успешно посадила первую ступень ракеты Falcon 9 на морскую платформу (Of Course I Still Love You)",
        },
        {
          id: 6,
          year: 2017,
          description:
            "Китайский квантовый спутник «Мо-Цзы» осуществил первую межконтинентальную квантовую видеосвязь",
        },
        {
          id: 7,
          year: 2018,
          description:
            "Европейский зонд «БепиКоломбо» отправился к Меркурию для изучения его магнитосферы и поверхности",
        },
        {
          id: 8,
          year: 2019,
          description:
            "Компания IBM представила первый коммерческий квантовый компьютер IBM Q System One",
        },
        {
          id: 9,
          year: 2020,
          description:
            "SpaceX и NASA успешно запустили пилотируемый корабль Crew Dragon к МКС (миссия Demo-2)",
        },
        {
          id: 10,
          year: 2021,
          description:
            "Китайский марсоход «Чжужун» успешно сел на Марс, став первой неамериканской миссией на поверхности планеты",
        },
        {
          id: 11,
          year: 2022,
          description:
            "Компания OpenAI представила ChatGPT — чат-бота на основе модели GPT-3.5, вызвавшего глобальный интерес к ИИ",
        },
      ],
    },
    {
      ...
      events: [
        {
          id: 1,
          year: 1981,
          description: "Премьера мюзикла «Кошки» в Лондоне",
        },
    ...
    },
    {
      ...
      events: [
        ...
        { id: 2, year: 1942, description: "Сталинградская битва" },
        {
          id: 3,
          year: 1944,
          description: "Открытие второго фронта в Нормандии",
        },
    ...
    },
    {
      ...
      events: [
        ...
        },
        {
          id: 2,
          year: 1965,
          description: "Первый выход человека в открытый космос",
        },
